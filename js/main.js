...
var options = {
  host: "hvx0lb.messaging.internetofthings.ibmcloud.com", // ORG ID
  port: "1883", // LEAVE IT AS IT IS
  clientId:
    "a:hvx0lb:" +
    Math.random()
      .toString(16)
      .substr(2, 8), // c_id x:xxx:
  username: "a-hvx0lb-fmrtwjrc6l", // APP KEY HERE
  password: "(LE_3cq4WM2C9eWIYP" // APP TOKEN HERE
};
